...
app.get('/', (c) => {
  const body = `
    <div class="grid">
      <div>
        <div class="eyebrow">Forgeon · Hono playground</div>
        <h1>Hono boilerplate, ready for deploy tests.</h1>
        <p>
          This service is a small <strong>Hono</strong> app you can use to test routing,
        ...
        <div class="pill-row">
          ...
          <div class="pill">Hono · Edge/Node</div>
      ...
      <div>
        <div class="links">
          ...
          <a href="/framework">
            /framework
            <span>– stack: Hono, TypeScript, etc.</span>
          </a>
          <a href="/status">
            /status
    ...
    <div class="meta">
      <span>Try deploying this to Forgeon as a simple Hono playground.</span>
      <span class="badge">hono-playground</span>
    </div>
  `
  return c.html(htmlShell('Forgeon Hono playground', body))
})
...
app.get('/info', (c) => {
  const body = `
    ...
    <div class="grid">
      <div>
        ...
        <h1>hono-playground · Forgeon-ready microservice</h1>
        <p>
  ...
  `
  return c.html(htmlShell('Forgeon · Hono Playground · Info', body))
})
...
app.get('/about', (c) => {
  const body = `
    ...
    <div>
      ...
      <h1>Hono app wired for Forgeon.</h1>
      <p>
        This tiny service is a <strong>Hono</strong> playground used to test how
        Forgeon talks to edge/serverless runtimes: health checks, routes, timeouts,
        and log streaming.
      </p>
      <p>
  ...
  `
  return c.html(htmlShell('Forgeon · About this Hono demo', body))
})
...
app.get('/framework', (c) => {
  const body = `
    ...
    <div class="grid">
      <div>
        ...
        <h1>Built with Hono & TypeScript.</h1>
        <p>
          The service uses <strong>Hono</strong> for routing on edge/serverless platforms,
          ideal for environments like Vercel or Forgeon runtimes. In playground mode it runs
  ...
  `
  return c.html(htmlShell('Forgeon · Hono Framework stack', body))
})
...
serve(
  ...
  (info) => {
    console.log(`🚀 Hono playground listening on http://localhost:${PORT}`)
  }
)
